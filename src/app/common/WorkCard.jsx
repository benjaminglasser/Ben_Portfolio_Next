    ...
    >
      <div className="group cursor-pointer w-full workcard">
        <ImageWithLoader
          ...
          borderOverlayClassName="border border-[#b02b1a] !rounded-none"
        ...
        <div className="flex gap-6 pt-3">
          ...
          <div className="w-full opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300 ease-out">
            ...
            <div className="flex justify-between gap-4 desc-mono uppercase tracking-wide text-[#a6564a] mt-4 text-[0.68rem] leading-relaxed">
              <div>Role: {role}</div>
