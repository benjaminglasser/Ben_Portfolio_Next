  ...
  return (
    <div className="w-full text-white">
      ...
      <h4 className="px-10 mt-16 md:font-thin">
        ...
        facilitating a more authentic performance. The use of ICVFX represents a
        significant shift in filmmaking, merging the physical and digital worlds
        to achieve unprecedented levels of realism and flexibility on set.
      </h4>
      ...
      <h4 className="px-10 mt-16 md:font-thin">
        ...
        robust pipeline for color correction, especially challenging given that
        the assets were delivered just a day before the event.{" "}
      </h4>
      ...
      <h4 className="px-10 mt-16 md:font-thin">
        ...
        thematic elements of the source material, demonstrating the potential of
        virtual production technology to recreate and enhance classic cinematic
        moments.
      </h4>
