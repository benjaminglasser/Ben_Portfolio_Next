...
const voyager = () => {
  ...
  return (
    <div className="w-full text-white">
      ...
      {/* <DetailSection className="px-5 md:px-20" title="PROCESS" widthFull left /> */}
      ...
      <Section>
        <Image
          src={PLUR.INSPO}
          alt="inspo"
          className="w-full h-full px-5 mt-4 md:px-20"
        />
      </Section>
      <Section>
        <p className="px-5 md:px-20 mt-5">
      ...
      <Section>
        <Image
          ...
          className="w-full h-full px-5 mt-2 md:px-20"
        />
      </Section>
      <Section>
        <Image
